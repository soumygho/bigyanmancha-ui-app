...
import { sayHello } from '../fn/hello-api/say-hello';
import { SayHello$Params } from '../fn/hello-api/say-hello';

@Injectable({ providedIn: 'root' })
export class HelloApiService extends BaseService {
  constructor(config: ApiConfiguration, http: HttpClient) {
    super(config, http);
  }

  /** Path part for operation `sayHello()` */
  static readonly SayHelloPath = '/api/hello';
